...
void	init_textures(t_data_game *_game)
{
	...
	texture = ft_malloc(sizeof(t_texture), ALLOC);
	texture->config = _game;
	texture->NO = _game->config->textures[0];
	texture->SO = _game->config->textures[1];
	texture->WE = _game->config->textures[2];
	texture->EA = _game->config->textures[3];
}
...
void	init_textures_data(t_data_game *_game)
{
	...
	texture = ft_malloc(sizeof(t_texture), ALLOC);
	texture->NO_img = ft_malloc(sizeof(t_imag), ALLOC);
	texture->SO_img = ft_malloc(sizeof(t_imag), ALLOC);
	texture->WE_img = ft_malloc(sizeof(t_imag), ALLOC);
	texture->EA_img = ft_malloc(sizeof(t_imag), ALLOC);
